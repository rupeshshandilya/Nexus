...
const resourcesData: Resource[] = [
  {
    ...
    description: 'A growing list of websites that are memorable, clear and delightful.',
        ...
        <div className="container mx-auto px-4 pb-20">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-4">
                ...
                <div className="relative sort-dropdown">
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 transition-transform duration-300 ${isOpenSort ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                  ...
                  {isOpenSort && (
                    <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-lg shadow-lg z-10 border border-gray-800 overflow-hidden animate-fadeIn">
                      {(['A-Z', 'Z-A', 'Newest', 'Oldest'] as SortOption[]).map((option) => (
                        <button
                          key={option}
                ...
                <div className="relative filter-dropdown">
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 transition-transform duration-300 ${isOpenFilter ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  {isOpenFilter && (
                    <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-lg shadow-lg z-10 border border-gray-800 overflow-hidden animate-fadeIn">
                      {(['None', 'UI', 'Tools', 'Resources', 'Accessibility'] as FilterOption[]).map((option) => (
                        <button
                          key={option}
                          className="block w-full text-left px-4 py-2.5 hover:bg-black/50 transition-colors"
                          onClick={() => {
          ...
          {displayedResources.length === 0 && (
            <div className="text-center py-16">
              <p className="text-xl text-gray-400">No resources found matching your filter criteria.</p>
              <button 
